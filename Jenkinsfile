...
//             sh 'export GITHUB_TOKEN=$token updateappmanifest --cluster CD --env env1 --folder argo --app frontend --manifest front-end.yaml  --version ${helm-version} --label test --repo_name tanmay6414/openinnovationai-frontend'
//           }
